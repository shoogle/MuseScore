...
enum ScoreState {
      ...
      STATE_DISABLED                            = 1 <<  0,
      STATE_NORMAL                              = 1 <<  1,
     // STATE_NOTE_ENTRY_STAFF_PITCHED            = 1 <<  2,
      STATE_NOTE_ENTRY_STAFF_DRUM               = 1 <<  3,
      STATE_NOTE_ENTRY_STAFF_TAB                = 1 <<  4,
      STATE_NOTE_ENTRY_METHOD_STEPTIME          = 1 <<  5,
      STATE_NOTE_ENTRY_METHOD_REPITCH           = 1 <<  6,
      STATE_NOTE_ENTRY_METHOD_RHYTHM            = 1 <<  7,
      STATE_NOTE_ENTRY_METHOD_REALTIME_AUTO     = 1 <<  8,
      STATE_NOTE_ENTRY_METHOD_REALTIME_MANUAL   = 1 <<  9,
      STATE_EDIT                                = 1 << 10,
      STATE_TEXT_EDIT                           = 1 << 11,
      STATE_LYRICS_EDIT                         = 1 << 12,
      STATE_HARMONY_FIGBASS_EDIT                = 1 << 13,
      STATE_PLAY                                = 1 << 14,
      STATE_FOTO                                = 1 << 15,
      STATE_LOCK                                = 1 << 16,
      ...
      STATE_NOTE_ENTRY_STAFF_PITCHED = STATE_NOTE_ENTRY_METHOD_STEPTIME | STATE_NOTE_ENTRY_METHOD_REPITCH
            | STATE_NOTE_ENTRY_METHOD_RHYTHM | STATE_NOTE_ENTRY_METHOD_REALTIME_AUTO | STATE_NOTE_ENTRY_METHOD_REALTIME_MANUAL,
